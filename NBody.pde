...
void setup() {
    ...
    //planets[1] = new ImagePlanet(new Point(1.4934e11d, 0), planets[0].getMass() / 2, 6.371e6d, new Vector(0, earthVel), loadImage("./assets/earth.png"), color(100, 100, 255));
    ...
    planets[2] = new ColorPlanet(new Point(planets[1].getX() + l1dist, 0), 6200, 1e3, new Vector(0, Math.tan(angV) * (planets[1].getX() + l1dist)), color(255, 0, 0));
    planets[3] = new ColorPlanet(new Point(planets[1].getX() - l1dist, 0), 6200, 1e3, new Vector(0, Math.tan(angV) * (planets[1].getX() - l1dist)), color(255, 0, 0));
}
